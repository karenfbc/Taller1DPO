...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar que país representa un atleta");
	...
	/**
	 * Le informa al usuario el nombre del país al cual representa el atleta
	 */
	private void ejecutarPaisQueRepresenta()
	{
		System.out.println("\n" + "Nombre del país al cual representa el atleta" + "\n");
		
		String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.PaisQueRepresenta(nombreAtleta);
		System.out.println("El país al que respresenta el atleta " + nombreAtleta + " es: " + pais);
	}
